 ...
 * @author Wilfred
 */
public class QueryOUType implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<OrganizationUnitTypes> list;
    ...
    public QueryOUType(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                List<OrganizationUnitTypes> list = da.searchOuTypes(sqlString);
                for (OrganizationUnitTypes e: list){
     ...
     * @return the list
     */
    public List<OrganizationUnitTypes> getList() {
        return list;
    }
