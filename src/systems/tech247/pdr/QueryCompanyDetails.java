 ...
 * @author Wilfred
 */
public class QueryCompanyDetails implements Lookup.Provider {
    ...
    public QueryCompanyDetails(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Companies..");
                ph.start();
                DataAccess da = new DataAccess();
                List<CompanyDetails> list = da.searchCompanyDetails(getSqlString());
                for (CompanyDetails e: list){
     ...
     * @return the list
     */
    public List<CompanyDetails> getList() {
        return list;
    }
