 ...
 * @author Wilfred
 */
public class QueryReferees implements Lookup.Provider {
    ...
    public QueryReferees(final Employees emp){
        this.emp = emp;
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Referees..");
                ph.start();
                DataAccess da = new DataAccess();
                Collection<Ref> list = da.searchReferees(emp);
                for (Ref e: list){
