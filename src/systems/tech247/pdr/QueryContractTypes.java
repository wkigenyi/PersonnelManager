 ...
 * @author Wilfred
 */
public class QueryContractTypes implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<PdContractTypes> list;
    
    public QueryContractTypes(){
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Contract Types..");
                ph.start();
                DataAccess da = new DataAccess();
                List<PdContractTypes> list = da.searchContractTypes(sqlString);
                for (PdContractTypes e: list){
     ...
     * @return the list
     */
    public List<PdContractTypes> getList() {
        return list;
    }
