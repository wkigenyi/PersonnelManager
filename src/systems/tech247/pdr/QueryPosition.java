 ...
 * @author Wilfred
 */
public class QueryPosition implements Lookup.Provider {
    ...
    public QueryPosition(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Positions..");
                ph.start();
                DataAccess da = new DataAccess();
                List<JobPositions> list = da.searchPositions(sqlString);
