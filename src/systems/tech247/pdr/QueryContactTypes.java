 ...
 * @author Wilfred
 */
public class QueryContactTypes implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString = "SELECT c FROM Ctypes c";
    private List<Ctypes> list;
    
    public QueryContactTypes(){
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Contact Types");
                ph.start();
                DataAccess da = new DataAccess();
                List<Ctypes> list = da.searchCtypes(getSqlString());
                for (Ctypes e: list){
