 ...
 * @author Wilfred
 */
public class QueryCompanyAssets implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<CompanyAssets> list;
    
    public QueryCompanyAssets(){
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                List<CompanyAssets> list = da.searchCompanyAssets(getSqlString());
                for (CompanyAssets e: list){
     ...
     * @return the list
     */
    public List<CompanyAssets> getList() {
        return list;
    }
