 ...
 * @author Wilfred
 */
public class QueryJobPositions implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<JobPositions> list;
    
    public QueryJobPositions(){
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Job Positions..");
                ph.start();
                DataAccess da = new DataAccess();
                List<JobPositions> list = da.searchJobPositions(sqlString);
                for (JobPositions e: list){
     ...
     * @return the list
     */
    public List<JobPositions> getList() {
        return list;
    }
