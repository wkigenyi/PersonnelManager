 ...
 * @author Wilfred
 */
public class QueryNation implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<Nationalities> list;
    ...
    public QueryNation(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                List<Nationalities> list = da.searchNations(getSqlString());
                for (Nationalities e: list){
     ...
     * @return the list
     */
    public List<Nationalities> getList() {
        return list;
    }
