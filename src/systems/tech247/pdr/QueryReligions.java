 ...
 * @author Wilfred
 */
public class QueryReligions implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<Religions> list;
    
    public QueryReligions(){
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                List<Religions> list = da.searchReligions(getSqlString());
                for (Religions e: list){
