 ...
 * @author Wilfred
 */
public class QueryJDCategories implements Lookup.Provider {
    
    InstanceContent ic;
    Lookup lookup;
    private String sqlString;
    private List<JDCategories> list;
    
    public QueryJDCategories(){
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading JD Categories ..");
                ph.start();
                DataAccess da = new DataAccess();
                List<JDCategories> list = da.searchJDCategories(sqlString);
                for (JDCategories e: list){
     ...
     * @return the list
     */
    public List<JDCategories> getList() {
        return list;
    }
