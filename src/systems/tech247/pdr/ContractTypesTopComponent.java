 ...
 */
@ConvertAsProperties(
        dtd = "-//systems.tech247.pdr//Contracttypes//EN",
        autostore = false
)
...
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_ContractTypesAction",
        preferredID = "ContractTypesTopComponent"
)
@Messages({
    "CTL_ContractTypesAction=Contract Types",
    "CTL_ContractTypesTopComponent=Ctypes Window",
    "HINT_ContractTypesTopComponent= "
})
public final class ContractTypesTopComponent extends TopComponent implements ExplorerManager.Provider {
    ...
    void loadItems(){
        em.setRootContext(new AbstractNode(Children.create(new FactoryContractTypes(query,false), true)));
    }
