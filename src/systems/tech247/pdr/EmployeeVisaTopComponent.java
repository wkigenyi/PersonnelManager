 ...
 */
@ConvertAsProperties(
        dtd = "-//systems.tech247.pdr//EmployeeVisa//EN",
        autostore = false
)
...
public final class EmployeeVisaTopComponent extends TopComponent implements ExplorerManager.Provider  {
    ...
    public void componentOpened() {
        em.setRootContext(new AbstractNode(Children.create(new FactoryEmployeeVisa(emp), true)));
    }
