 ...
 */
@ConvertAsProperties(
        dtd = "-//systems.tech247.pdr//EmployeeAwards//EN",
        autostore = false
)
...
@Messages({
    ...
    "HINT_EmployeeAwardsTopComponent="
})
public final class EmployeeAwardsTopComponent extends TopComponent implements ExplorerManager.Provider  {
    ...
    public void componentOpened() {
        em.setRootContext(new AbstractNode(Children.create(new FactoryEmployeeAwards(emp), true)));
    }
