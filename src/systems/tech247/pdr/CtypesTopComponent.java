...
@TopComponent.Description(
        preferredID = "CtypesTopComponent",
        iconBase = "systems/tech247/util/icons/settings.png",
        persistenceType = TopComponent.PERSISTENCE_ALWAYS
)
@TopComponent.Registration(mode = "explorer", openAtStartup = false)
@ActionID(category = "PDR", id = "systems.tech247.pdr.CtypesTopComponent")
//@ActionReference(path = "Menu/PDR" /*, position = 333 */)
//@TopComponent.OpenActionRegistration(
//        displayName = "#CTL_CtypesAction",
//        preferredID = "CtypesTopComponent"
//)
@Messages({
    "CTL_CtypesAction=Contact Types",
    "CTL_CtypesTopComponent=Ctypes Window",
    "HINT_CtypesTopComponent= "
})
public final class CtypesTopComponent extends TopComponent implements ExplorerManager.Provider {
    
    ExplorerManager em = new ExplorerManager();
    
    String searchString = "SELECT ";
    QueryContactTypes query = new QueryContactTypes();
    public CtypesTopComponent() {
        initComponents();
        ...
        searchString ="SELECT r from Ctypes r";
