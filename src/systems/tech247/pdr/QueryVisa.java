 ...
 * @author Wilfred
 */
public class QueryVisa implements Lookup.Provider {
    ...
    public QueryVisa(final Employees emp){
        this.emp = emp;
        list = new ArrayList<>();
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Visas..");
                ph.start();
                DataAccess da = new DataAccess();
                Collection<Visa> list = da.searchVisa(emp);
                for (Visa e: list){
