 ...
 * @author Wilfred
 */
public class FactoryEmployeesManifest extends ChildFactory<Object>{

    QueryEmployee query;
    
    public FactoryEmployeesManifest(QueryEmployee query){
        this.query = query;
    }
    ...
    protected Node createNodeForKey(Object key){
        ...
        if(key instanceof Employees){
            node = new NodeEmployeeManifest((Employees)key);
        }else{
