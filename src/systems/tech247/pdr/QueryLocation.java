 ...
 * @author Wilfred
 */
public class QueryLocation implements Lookup.Provider {
    ...
    public QueryLocation(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Locations..");
                ph.start();
                DataAccess da = new DataAccess();
                List<Locations> list = da.searchLocations(getSqlString());
