 ...
 * @author Wilfred
 */
public class QueryCountry implements Lookup.Provider {
    ...
    public QueryCountry(){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Countries..");
                ph.start();
                DataAccess da = new DataAccess();
                List<Countries> list = da.searchCountries(getSqlString());
                for (Countries e: list){
