 ...
 * @author Wilfred
 */
public class QueryJDCategoryForJob implements Lookup.Provider {
    ...
    public QueryJDCategoryForJob(final JobPositions position){
        ...
        ic.add(new ReloadableQueryCapability() {
            ...
            public void reload() throws Exception {
                ...
                ProgressHandle ph = ProgressHandleFactory.createHandle("Loading Categories..");
                ph.start();
                DataAccess da = new DataAccess();
                Collection<Integer> list = da.searchJDCategoriesForJob(position);
                for (Integer e: list){
