...
import systems.tech247.pdr.QueryFamily;
 ...
 * @author Admin
 */
public class EmpFamilyPanel extends javax.swing.JPanel implements LookupListener,ExplorerManager.Provider{
    
    ExplorerManager em = UtilityPDR.emEmployeeFamily;
    Employees emp;
    ...
    private class RootNode extends AbstractNode{
        ...
        private RootNode (InstanceContent ic, Employees emp){
            super(Children.create(new FactoryItems(new QueryFamily(emp)), true), new AbstractLookup(ic));
            instanceContent = ic;
    ...
    public class FactoryItems extends ChildFactory<Family>{

        QueryFamily query;
    
    public FactoryItems(QueryFamily query){
        this.query = query;
    }
    ...
    private class ItemNode extends AbstractNode{
        ...
        public ItemNode(Family emp){
            this(new InstanceContent(),emp);
        }
        
        private ItemNode (InstanceContent ic, Family emp){
