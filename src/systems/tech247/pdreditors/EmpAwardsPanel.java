 ...
 * @author Admin
 */
public class EmpAwardsPanel extends javax.swing.JPanel implements LookupListener,ExplorerManager.Provider{
    
    ExplorerManager em = UtilityPDR.emEmployeeAwards;
    Employees emp;
     ...
     */
    public EmpAwardsPanel() {
        initComponents();
        //Start transaction
        OutlineView ov = new OutlineView("Employment Awards");
