...
import systems.tech247.pdr.NodeRefreshProfEvent;
 ...
 */
@ConvertAsProperties(
        dtd = "-//systems.tech247.pdreditors//ProfEditor//EN",
        autostore = false
)
@TopComponent.Description(
        preferredID = "ProfEditorTopComponent",
        //iconBase="SET/PATH/TO/ICON/HERE", 
        persistenceType = TopComponent.PERSISTENCE_NEVER
)
@TopComponent.Registration(mode = "editor", openAtStartup = false)
@ActionID(category = "Window", id = "systems.tech247.pdreditors.ProfEditorTopComponent")
@ActionReference(path = "Menu/Window" /*, position = 333 */)
@TopComponent.OpenActionRegistration(
        displayName = "#CTL_ProfEditorAction",
        preferredID = "ProfEditorTopComponent"
)
@Messages({
    "CTL_ProfEditorAction=Prof Editor",
    "CTL_ProfEditorTopComponent=Prof Editor",
    "HINT_ProfEditorTopComponent="
})
public final class ProfEditorTopComponent extends TopComponent{
    ...
    public ProfEditorTopComponent(){
        this(null);
    }
    
    public ProfEditorTopComponent(Employees employee){
        this(null,employee);
        
    }
    
    
    public ProfEditorTopComponent(Prof contact,Employees emp) {
        initComponents();
        setName(Bundle.CTL_ProfEditorTopComponent());
        setToolTipText(Bundle.HINT_ProfEditorTopComponent());
        associateLookup(new AbstractLookup(ic));
        this.emp = emp;
        this.application = contact;
        if(null!=application){
            this.updateable = DataAccess.getEntityManager().find(Prof.class, contact.getId());
    ...
    private class EmploymentSavable extends AbstractSavable{
        ...
        protected String findDisplayName() {
            if(null==application){
                ...
                return "Prof For" + emp.getSurName()+" "+emp.getOtherNames();
            }else{
                return "Proffession";
            }
        }
        
        ProfEditorTopComponent tc(){
            return ProfEditorTopComponent.this;
        }
...
"           (?,?,?,?,?,?,?,?,?,?,?)";
            ...
            UtilityPDR.pdrIC.set(Arrays.asList(new NodeRefreshProfEvent()), null);
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel2, org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jLabel2.text")); // NOI18N

        jtInsititute.setText(org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jtInsititute.text")); // NOI18N
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel7, org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jLabel7.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jLabel1.text")); // NOI18N

        jtComments.setColumns(20);
        jtComments.setRows(5);
        jScrollPane1.setViewportView(jtComments);

        jtCourse.setText(org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jtCourse.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel8, org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jLabel8.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel9, org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jLabel9.text")); // NOI18N

        org.openide.awt.Mnemonics.setLocalizedText(jLabel11, org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jLabel11.text")); // NOI18N

        jtAward.setText(org.openide.util.NbBundle.getMessage(ProfEditorTopComponent.class, "ProfEditorTopComponent.jtAward.text")); // NOI18N
