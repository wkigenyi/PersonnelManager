 ...
 * @author Admin
 */
public class EmpBankAccountsPanel extends javax.swing.JPanel implements LookupListener,ExplorerManager.Provider{
    
    ExplorerManager em = UtilityPDR.emEmployeeBankAccounts;
    Employees emp;
     ...
     */
    public EmpBankAccountsPanel() {
        initComponents();
        //Start transaction
        OutlineView ov = new OutlineView("Employee Bank Accounts");
