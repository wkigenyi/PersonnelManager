 ...
 * @author Admin
 */
public class PDRContractTypesPanel extends javax.swing.JPanel implements ExplorerManager.Provider{
    
    ExplorerManager em = UtilityPDR.pdrContractTypes;
    ...
    public PDRContractTypesPanel() {
        ...
        sqlString ="SELECT r from PdContractTypes r";
        ...
        jtsearch.addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                sqlString ="SELECT r from PdContractTypes r WHERE r.description LIKE '%"+searchString+"%'";
                UtilityPDR.loadContractTypes(sqlString);
            }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(PDRContractTypesPanel.class, "PDRContractTypesPanel.jLabel1.text")); // NOI18N

        jtsearch.setBackground(new java.awt.Color(51, 255, 255));
        jtsearch.setText(org.openide.util.NbBundle.getMessage(PDRContractTypesPanel.class, "PDRContractTypesPanel.jtsearch.text")); // NOI18N
