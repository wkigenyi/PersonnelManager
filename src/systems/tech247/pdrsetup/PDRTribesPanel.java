...
import systems.tech247.pdr.QueryTribe;
 ...
 * @author Admin
 */
public class PDRTribesPanel extends javax.swing.JPanel implements ExplorerManager.Provider{
    
    ExplorerManager em = UtilityPDR.pdrTribes;
    ...
    public PDRTribesPanel() {
        ...
        sqlString ="SELECT r from Tribes r";
        UtilityPDR.loadTribes(sqlString);
        ...
        jtsearch.addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                sqlString ="SELECT r from Tribes r WHERE r.tribe LIKE '%"+searchString+"%'";
                UtilityPDR.loadTribes(sqlString);
            }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(PDRTribesPanel.class, "PDRTribesPanel.jLabel1.text")); // NOI18N

        jtsearch.setBackground(new java.awt.Color(51, 255, 255));
        jtsearch.setText(org.openide.util.NbBundle.getMessage(PDRTribesPanel.class, "PDRTribesPanel.jtsearch.text")); // NOI18N
