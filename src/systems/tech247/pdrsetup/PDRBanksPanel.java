 ...
 * @author Admin
 */
public class PDRBanksPanel extends javax.swing.JPanel implements ExplorerManager.Provider{
    
    ExplorerManager em = UtilityPDR.pdrBanks;
    ...
    public PDRBanksPanel() {
        ...
        UtilityPDR.loadBanks(sqlString);
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(PDRBanksPanel.class, "PDRBanksPanel.jLabel1.text")); // NOI18N

        jTSearchDepartments.setBackground(new java.awt.Color(51, 255, 255));
        jTSearchDepartments.setText(org.openide.util.NbBundle.getMessage(PDRBanksPanel.class, "PDRBanksPanel.jTSearchDepartments.text")); // NOI18N
