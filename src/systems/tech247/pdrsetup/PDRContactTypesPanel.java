 ...
 * @author Admin
 */
public class PDRContactTypesPanel extends javax.swing.JPanel implements ExplorerManager.Provider{
    
    ExplorerManager em = UtilityPDR.pdrContactTypes;
    ...
    public PDRContactTypesPanel() {
        ...
        sqlString ="SELECT r from Ctypes r";
        UtilityPDR.loadContactTypes(sqlString);
        ...
        jtsearch.addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                sqlString ="SELECT r from Ctypes r WHERE r.description LIKE '%"+searchString+"%'";
                UtilityPDR.loadContactTypes(sqlString);
            }
    ...
    private void initComponents() {
        ...
        org.openide.awt.Mnemonics.setLocalizedText(jLabel1, org.openide.util.NbBundle.getMessage(PDRContactTypesPanel.class, "PDRContactTypesPanel.jLabel1.text")); // NOI18N

        jtsearch.setBackground(new java.awt.Color(51, 255, 255));
        jtsearch.setText(org.openide.util.NbBundle.getMessage(PDRContactTypesPanel.class, "PDRContactTypesPanel.jtsearch.text")); // NOI18N
